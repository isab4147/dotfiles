...
keys.globalkeys = gears.table.join(
    ...
    -- Media keys
    awful.key({ superkey }, "period", function() awful.spawn.with_shell("playerctl -p ncspot next") end,
        {description = "next song", group = "media"}),
    awful.key({ superkey }, "comma", function() awful.spawn.with_shell("playerctl -p ncspot previous") end,
